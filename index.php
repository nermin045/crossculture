            ...
            <div class="row">
                    ...
                    <div class="grid mask">
                        <figure>
                            <img class="img-responsive"
                                 src="images/community/cworld.jpg" alt="">
                            <figcaption>
                ...
                <div class="col-md-4  col-sm-6">
                    <div class="grid mask">
                        <figure>
                            <img class="img-responsive"
                                 src="images/community/cgr.jpg" alt="">
                            <figcaption>
